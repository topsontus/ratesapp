...
ActiveRecord::Schema.define(version: 2020_05_17_202533) do
  ...
  create_table "rates", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.decimal "forced_rate", precision: 10, scale: 4, default: "0.0", null: false
    t.string "currency_from"
    t.string "currency_to"
    t.datetime "forced_rate_expiration"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["created_at"], name: "index_rates_on_created_at"
  end
